"""Per-world access enforcement (ADR 0003 Slice A).
...
def issue_token(settings: Settings, world_id: str) -> str | None:
    """Mint a token for a freshly created world, or ``None`` when off.

    Returned on the create response and stored client-side keyed by world_id.
    """
