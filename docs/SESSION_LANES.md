...
`scratch/collab/<lane>-brief.md` (the Orchestrator writes one brief per lane
*before* every launch — the seam-change briefs of § 4 are the same file, updated
per item), then reply to the Orchestrator with
